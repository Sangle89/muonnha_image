 ...
 */
$config['site_title']                 = "Bannharieng.vn";       // Site Title, example.com
$config['admin_email']                = "bannharieng.vn@gmail.com"; // Admin Email, admin@example.com
$config['default_group']              = 'members';           // Default group, use name
$config['admin_group']                = 'admin';             // Default administrators group, use name
$config['writer_group']                = 'writer';  
...
/*
 ...
 | Default: auth/
 */
$config['email_templates'] = 'default/email/';
/*
 | -------------------------------------------------------------------------
